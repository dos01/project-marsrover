						...
						<div class="card" >
							...
							<div class="header pt-3 grey lighten-2">
								<div class="row">
									...
									<div class="col" style="text-align:right">
										<button onclick="location.href = '3d.php';" type="button" title="3D Coordinates" class="btn btn-outline-primary btn-sm px-2">
							...
							<div class="card-body mx-4 mt-4">
								...
								<div class="md-form">
									...
									<label for="comID">CPUID</label>
								</div>
								<div class="md-form">
									<input type="text" id="comName" class="form-control">
									<label for="comName">Name</label>
								</div>
								<div class="md-form">
									<input type="text" id="comOS" class="form-control">
									<label for="comOS">OS</label>
								</div>
								<div class="md-form">
									<input type="text" id="comEEP" class="form-control">
									<label for="comEEP">EEPROM</label>
								</div>
								<div class="md-form">
									<input type="text" id="comDRAM" class="form-control">
									<label for="comDRAM">DRAM</label>
								</div>
								<div class="md-form">
									<input type="text" id="comFlash" class="form-control">
									<label for="comFlash">Flash</label>
								</div>
								<div class="md-form">
									<input type="text" id="comRoverID" class="form-control">
									<label for="comRoverID">RoverID</label>
								</div>
								<br>
