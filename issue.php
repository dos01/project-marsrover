					...
					<section class="form-simple">
						...
						<div class="card" >
							...
							<div class="card-body mx-4 mt-4">
								...
								<!--Body-->
								<div class="md-form">
									<input type="text" id="issID" class="form-control">
									<label for="issID">IssueID</label>
								</div>
								<div class="md-form">
									<input type="text" id="issDate" class="form-control">
									<label for="issDate">Date</label>
								</div>
								<div class="md-form">
									<input type="text" id="issOTime" class="form-control">
									<label for="issOTime">Occured Time</label>
								</div>
								<div class="md-form">
									<input type="text" id="issUnit" class="form-control">
									<label for="issUnit">Unit</label>
								</div>
								<div class="md-form">
									<input type="text" id="issDesc" class="form-control">
									<label for="issDesc">Description</label>
								</div>
								<div class="md-form">
									<input type="text" id="issRoverID" class="form-control">
									<label for="issRoverID">RoverID</label>
								</div>
								<br>
