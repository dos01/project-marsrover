						...
						<div class="card" >
							...
							<div class="card-body mx-4 mt-4">
								...
								<div class="row">
									<div class="col-6">
										<div class="md-form">
											<input type="text" id="comDID" class="form-control">
											<label for="comDID">Device ID</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDPro" class="form-control">
											<label for="comDPro">Protocol</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDDTime" class="form-control">
											<label for="comDDTime">Delay Time</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDRBand" class="form-control">
											<label for="comDRBand">Related Band</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDFBand" class="form-control">
											<label for="comDFBand">Frequency Band</label>
										</div>
									</div>
									<div class="col-6">
										<div class="md-form">
											<input type="text" id="comDWRange" class="form-control">
											<label for="comDWRange">Wavelength Range</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDType" class="form-control">
											<label for="comDType">Type</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDTrS" class="form-control">
											<label for="comDTrS">Transfer Speed</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDRover" class="form-control">
											<label for="comDRover">Rover ID</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDOrbiter" class="form-control">
											<label for="comDOrbiter">Orbiter ID</label>
										</div>
										<div class="md-form">
											<input type="text" id="comDCPUID" class="form-control">
